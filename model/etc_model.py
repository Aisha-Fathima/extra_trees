...
# Function to train the machine learning model using ExtraTreesClassifier
def create_model(data):
    ...
    return extra_trees, scaler, imputer, pca
...
def main():
    ...
    extra_trees_model, scaler, imputer, pca = create_model(data)
